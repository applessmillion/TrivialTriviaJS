...
// symbols:
(lib.loadingtile = function() { this.initialize(ss["loader_atlas_"]); this.gotoAndStop(0); }).prototype = p = new cjs.Sprite();
// helper functions:
...
lib.properties = {
	...
	color: "#00002D",
	opacity: 1.00,
	manifest: [ {src:"images/loader_atlas_.png", id:"loader_atlas_"} ],
	preloads: []
};

// bootstrap callback support:
(lib.Stage = function(canvas) { createjs.Stage.call(this, canvas); }).prototype = p = new createjs.StageGL();
